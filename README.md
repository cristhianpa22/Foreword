...
index.html: Contiene toda la estructura HTML semántica, la definición de Tokens (@theme), Componentes Reutilizables (@layer components) y el script de carga de tema.
